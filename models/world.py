...
class ItemTemplate(DeclarativeBase):
    ...
    unk0 = Column(u'unk0', INTEGER(), nullable=False)
...
class QuestTemplate(DeclarativeBase):
    ...
    #column definitions
    CompleteScript = Column(u'CompleteScript', Integer(), nullable=False)
    ...
    DetailsEmote1 = Column(u'DetailsEmote1', SMALLINT(), nullable=False)
    DetailsEmote2 = Column(u'DetailsEmote2', SMALLINT(), nullable=False)
    DetailsEmote3 = Column(u'DetailsEmote3', SMALLINT(), nullable=False)
    DetailsEmote4 = Column(u'DetailsEmote4', SMALLINT(), nullable=False)
    DetailsEmoteDelay1 = Column(u'DetailsEmoteDelay1', INTEGER(), nullable=False)
    DetailsEmoteDelay2 = Column(u'DetailsEmoteDelay2', INTEGER(), nullable=False)
    DetailsEmoteDelay3 = Column(u'DetailsEmoteDelay3', INTEGER(), nullable=False)
    DetailsEmoteDelay4 = Column(u'DetailsEmoteDelay4', INTEGER(), nullable=False)
    EmoteOnComplete = Column(u'EmoteOnComplete', SMALLINT(), nullable=False)
    EmoteOnIncomplete = Column(u'EmoteOnIncomplete', SMALLINT(), nullable=False)
    ...
    ExclusiveGroup = Column(u'ExclusiveGroup', Integer(), nullable=False)
    Flags = Column(u'Flags', INTEGER(), nullable=False)
    Id = Column(u'Id', Integer(), primary_key=True, nullable=False)
    Level = Column(u'Level', SMALLINT(), nullable=False)
    LimitTime = Column(u'LimitTime', INTEGER(), nullable=False)
    MaxLevel = Column(u'MaxLevel', Integer(), nullable=False)
    Method = Column(u'Method', Integer(), nullable=False)
    MinLevel = Column(u'MinLevel', Integer(), nullable=False)
    NextQuestId = Column(u'NextQuestId', Integer(), nullable=False)
    NextQuestIdChain = Column(u'NextQuestIdChain', Integer(), nullable=False)
    ...
    OfferRewardEmote1 = Column(u'OfferRewardEmote1', SMALLINT(), nullable=False)
    OfferRewardEmote2 = Column(u'OfferRewardEmote2', SMALLINT(), nullable=False)
    OfferRewardEmote3 = Column(u'OfferRewardEmote3', SMALLINT(), nullable=False)
    OfferRewardEmote4 = Column(u'OfferRewardEmote4', SMALLINT(), nullable=False)
    OfferRewardEmoteDelay1 = Column(u'OfferRewardEmoteDelay1', INTEGER(), nullable=False)
    OfferRewardEmoteDelay2 = Column(u'OfferRewardEmoteDelay2', INTEGER(), nullable=False)
    OfferRewardEmoteDelay3 = Column(u'OfferRewardEmoteDelay3', INTEGER(), nullable=False)
    OfferRewardEmoteDelay4 = Column(u'OfferRewardEmoteDelay4', INTEGER(), nullable=False)
    ...
    PointMapId = Column(u'PointMapId', SMALLINT(), nullable=False)
    PointOption = Column(u'PointOption', Integer(), nullable=False)
    PointX = Column(u'PointX', FLOAT(precision=None, asdecimal=False), nullable=False)
    PointY = Column(u'PointY', FLOAT(precision=None, asdecimal=False), nullable=False)
    PrevQuestId = Column(u'PrevQuestId', Integer(), nullable=False)
    ...
    RequiredClasses = Column(u'RequiredClasses', SMALLINT(), nullable=False)
    RequiredFactionId1 = Column(u'RequiredFactionId1', SMALLINT(), nullable=False)
    RequiredFactionId2 = Column(u'RequiredFactionId2', SMALLINT(), nullable=False)
    RequiredFactionValue1 = Column(u'RequiredFactionValue1', Integer(), nullable=False)
    RequiredFactionValue2 = Column(u'RequiredFactionValue2', Integer(), nullable=False)
    RequiredItemCount1 = Column(u'RequiredItemCount1', SMALLINT(), nullable=False)
    RequiredItemCount2 = Column(u'RequiredItemCount2', SMALLINT(), nullable=False)
    RequiredItemCount3 = Column(u'RequiredItemCount3', SMALLINT(), nullable=False)
    RequiredItemCount4 = Column(u'RequiredItemCount4', SMALLINT(), nullable=False)
    RequiredItemCount5 = Column(u'RequiredItemCount5', SMALLINT(), nullable=False)
    RequiredItemCount6 = Column(u'RequiredItemCount6', SMALLINT(), nullable=False)
    RequiredItemId1 = Column(u'RequiredItemId1', Integer(), nullable=False)
    RequiredItemId2 = Column(u'RequiredItemId2', Integer(), nullable=False)
    RequiredItemId3 = Column(u'RequiredItemId3', Integer(), nullable=False)
    RequiredItemId4 = Column(u'RequiredItemId4', Integer(), nullable=False)
    RequiredItemId5 = Column(u'RequiredItemId5', Integer(), nullable=False)
    RequiredItemId6 = Column(u'RequiredItemId6', Integer(), nullable=False)
    RequiredMaxRepFaction = Column(u'RequiredMaxRepFaction', SMALLINT(), nullable=False)
    RequiredMaxRepValue = Column(u'RequiredMaxRepValue', Integer(), nullable=False)
    RequiredMinRepFaction = Column(u'RequiredMinRepFaction', SMALLINT(), nullable=False)
    RequiredMinRepValue = Column(u'RequiredMinRepValue', Integer(), nullable=False)
    RequiredNpcOrGo1 = Column(u'RequiredNpcOrGo1', Integer(), nullable=False)
    RequiredNpcOrGo2 = Column(u'RequiredNpcOrGo2', Integer(), nullable=False)
    RequiredNpcOrGo3 = Column(u'RequiredNpcOrGo3', Integer(), nullable=False)
    RequiredNpcOrGo4 = Column(u'RequiredNpcOrGo4', Integer(), nullable=False)
    RequiredNpcOrGoCount1 = Column(u'RequiredNpcOrGoCount1', SMALLINT(), nullable=False)
    RequiredNpcOrGoCount2 = Column(u'RequiredNpcOrGoCount2', SMALLINT(), nullable=False)
    RequiredNpcOrGoCount3 = Column(u'RequiredNpcOrGoCount3', SMALLINT(), nullable=False)
    RequiredNpcOrGoCount4 = Column(u'RequiredNpcOrGoCount4', SMALLINT(), nullable=False)
    RequiredPlayerKills = Column(u'RequiredPlayerKills', Integer(), nullable=False)
    RequiredRaces = Column(u'RequiredRaces', SMALLINT(), nullable=False)
    RequiredSkillId = Column(u'RequiredSkillId', SMALLINT(), nullable=False)
    RequiredSkillPoints = Column(u'RequiredSkillPoints', SMALLINT(), nullable=False)
    RequiredSourceItemCount1 = Column(u'RequiredSourceItemCount1', SMALLINT(), nullable=False)
    RequiredSourceItemCount2 = Column(u'RequiredSourceItemCount2', SMALLINT(), nullable=False)
    RequiredSourceItemCount3 = Column(u'RequiredSourceItemCount3', SMALLINT(), nullable=False)
    RequiredSourceItemCount4 = Column(u'RequiredSourceItemCount4', SMALLINT(), nullable=False)
    RequiredSourceItemId1 = Column(u'RequiredSourceItemId1', Integer(), nullable=False)
    RequiredSourceItemId2 = Column(u'RequiredSourceItemId2', Integer(), nullable=False)
    RequiredSourceItemId3 = Column(u'RequiredSourceItemId3', Integer(), nullable=False)
    RequiredSourceItemId4 = Column(u'RequiredSourceItemId4', Integer(), nullable=False)
    RequiredSpellCast1 = Column(u'RequiredSpellCast1', Integer(), nullable=False)
    RequiredSpellCast2 = Column(u'RequiredSpellCast2', Integer(), nullable=False)
    RequiredSpellCast3 = Column(u'RequiredSpellCast3', Integer(), nullable=False)
    RequiredSpellCast4 = Column(u'RequiredSpellCast4', Integer(), nullable=False)
    RewardArenaPoints = Column(u'RewardArenaPoints', SMALLINT(), nullable=False)
    RewardChoiceItemCount1 = Column(u'RewardChoiceItemCount1', SMALLINT(), nullable=False)
    RewardChoiceItemCount2 = Column(u'RewardChoiceItemCount2', SMALLINT(), nullable=False)
    RewardChoiceItemCount3 = Column(u'RewardChoiceItemCount3', SMALLINT(), nullable=False)
    RewardChoiceItemCount4 = Column(u'RewardChoiceItemCount4', SMALLINT(), nullable=False)
    RewardChoiceItemCount5 = Column(u'RewardChoiceItemCount5', SMALLINT(), nullable=False)
    RewardChoiceItemCount6 = Column(u'RewardChoiceItemCount6', SMALLINT(), nullable=False)
    RewardChoiceItemId1 = Column(u'RewardChoiceItemId1', Integer(), nullable=False)
    RewardChoiceItemId2 = Column(u'RewardChoiceItemId2', Integer(), nullable=False)
    RewardChoiceItemId3 = Column(u'RewardChoiceItemId3', Integer(), nullable=False)
    RewardChoiceItemId4 = Column(u'RewardChoiceItemId4', Integer(), nullable=False)
    RewardChoiceItemId5 = Column(u'RewardChoiceItemId5', Integer(), nullable=False)
    RewardChoiceItemId6 = Column(u'RewardChoiceItemId6', Integer(), nullable=False)
    RewardFactionId1 = Column(u'RewardFactionId1', SMALLINT(), nullable=False)
    RewardFactionId2 = Column(u'RewardFactionId2', SMALLINT(), nullable=False)
    RewardFactionId3 = Column(u'RewardFactionId3', SMALLINT(), nullable=False)
    RewardFactionId4 = Column(u'RewardFactionId4', SMALLINT(), nullable=False)
    RewardFactionId5 = Column(u'RewardFactionId5', SMALLINT(), nullable=False)
    RewardFactionValueId1 = Column(u'RewardFactionValueId1', Integer(), nullable=False)
    RewardFactionValueId2 = Column(u'RewardFactionValueId2', Integer(), nullable=False)
    RewardFactionValueId3 = Column(u'RewardFactionValueId3', Integer(), nullable=False)
    RewardFactionValueId4 = Column(u'RewardFactionValueId4', Integer(), nullable=False)
    RewardFactionValueId5 = Column(u'RewardFactionValueId5', Integer(), nullable=False)
    RewardFactionValueIdOverride1 = Column(u'RewardFactionValueIdOverride1', Integer(), nullable=False)
    RewardFactionValueIdOverride2 = Column(u'RewardFactionValueIdOverride2', Integer(), nullable=False)
    RewardFactionValueIdOverride3 = Column(u'RewardFactionValueIdOverride3', Integer(), nullable=False)
    RewardFactionValueIdOverride4 = Column(u'RewardFactionValueIdOverride4', Integer(), nullable=False)
    RewardFactionValueIdOverride5 = Column(u'RewardFactionValueIdOverride5', Integer(), nullable=False)
    RewardHonor = Column(u'RewardHonor', INTEGER(), nullable=False)
    RewardHonorMultiplier = Column(u'RewardHonorMultiplier', FLOAT(precision=None, asdecimal=False), nullable=False)
    RewardItemCount1 = Column(u'RewardItemCount1', SMALLINT(), nullable=False)
    RewardItemCount2 = Column(u'RewardItemCount2', SMALLINT(), nullable=False)
    RewardItemCount3 = Column(u'RewardItemCount3', SMALLINT(), nullable=False)
    RewardItemCount4 = Column(u'RewardItemCount4', SMALLINT(), nullable=False)
    RewardItemId1 = Column(u'RewardItemId1', Integer(), nullable=False)
    RewardItemId2 = Column(u'RewardItemId2', Integer(), nullable=False)
    RewardItemId3 = Column(u'RewardItemId3', Integer(), nullable=False)
    RewardItemId4 = Column(u'RewardItemId4', Integer(), nullable=False)
    RewardMailDelay = Column(u'RewardMailDelay', INTEGER(), nullable=False)
    RewardMailTemplateId = Column(u'RewardMailTemplateId', Integer(), nullable=False)
    RewardMoneyMaxLevel = Column(u'RewardMoneyMaxLevel', INTEGER(), nullable=False)
    RewardOrRequiredMoney = Column(u'RewardOrRequiredMoney', INTEGER(), nullable=False)
    RewardSpell = Column(u'RewardSpell', Integer(), nullable=False)
    RewardSpellCast = Column(u'RewardSpellCast', INTEGER(), nullable=False)
    RewardTalents = Column(u'RewardTalents', Integer(), nullable=False)
    RewardTitleId = Column(u'RewardTitleId', Integer(), nullable=False)
    RewardXPId = Column(u'RewardXPId', Integer(), nullable=False)
    SourceItemCount = Column(u'SourceItemCount', Integer(), nullable=False)
    SourceItemId = Column(u'SourceItemId', Integer(), nullable=False)
    SourceSpellId = Column(u'SourceSpellId', Integer(), nullable=False)
    SpecialFlags = Column(u'SpecialFlags', Integer(), nullable=False)
    StartScript = Column(u'StartScript', Integer(), nullable=False)
    SuggestedPlayers = Column(u'SuggestedPlayers', Integer(), nullable=False)
    ...
    Type = Column(u'Type', SMALLINT(), nullable=False)
    Unknown0 = Column(u'Unknown0', Integer(), nullable=False)
    WDBVerified = Column(u'WDBVerified', SMALLINT(), nullable=False)
    ZoneOrSort = Column(u'ZoneOrSort', SMALLINT(), nullable=False)
